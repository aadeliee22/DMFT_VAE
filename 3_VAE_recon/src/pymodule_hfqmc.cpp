...
typedef py::array_t<int> PySpins;
...
public:
  ...
  double do_montecarlo_step(PySpins v0, PySpins v1, const int nperiodSweeps)
  {
    auto wrap_v0 = v0.mutable_unchecked<1>();
    auto wrap_v1 = v1.mutable_unchecked<1>();
    return hfqmc_->do_montecarlo_step(&wrap_v0(0), &wrap_v1(0), nperiodSweeps);
  }
  ...
  void get_auxiliary_fields(PySpins pyspins)
  {
